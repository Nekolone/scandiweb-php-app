...
function add_type_0($SKU, $name, $price, $image__link, $item__type, $size)
{
    $mysqli = msl();
    $mysqli->query("SET NAMES 'utf8'");
    $mysqli->query("INSERT INTO `Product` (`SKU`, `name`, `addTime`, `price`, `image__link`, `item__type`) VALUES ('$SKU', '$name', NULL, '$price','$image__link','$item__type')");
...
function add_type_1($SKU, $name, $price, $image__link, $item__type, $height, $width, $length)
{
...
function add_type_2($SKU, $name, $price, $image__link, $item__type, $weight)
{
